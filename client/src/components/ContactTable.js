        ...
        <div className="contact">
          <div className="d-flex flex-row justify-content-between">
            <div className="p2">
              ...
              <p className="font-weight-bold"><a href="https://s3-us-west-1.amazonaws.com/rlthomas-pdf-resume/RandyThomasResume2_CV.pdf" download><img src="/images/INSTANT_MESSAGE.png" width="30px" />{' '} Download Resume </a></p>
